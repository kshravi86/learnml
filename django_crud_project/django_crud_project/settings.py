...
SECRET_KEY = 'django-insecure-placeholder-key' # Replace with a real secret key
...
INSTALLED_APPS = [
    ...
    'items_app.apps.ItemsAppConfig', # Added items_app
]
...
DATABASES = {
    'default': {
        ...
        'PORT': '5432',                # Or your DB port (default is 5432)
    }
}
